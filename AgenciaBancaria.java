...
public class AgenciaBancaria {
    ...
    public static void operacoes() {
        ...
        System.out.println("-----------------------");
        System.out.println("-----Bem Vindos ao banco de todos-----");
        System.out.println("-----------------------");
        ...
        int operacao = input.nextInt(); // guarda o valor digitado
        ...
        case 5:
            ...
            break;
        case 6:
            System.out.println("Obrigado por usar a agência de todos"); 
            System.exit(0);
        default: 
